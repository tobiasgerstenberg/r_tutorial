...
You can also evaluate R code in line with other text like so: The value of `a` is `r a`. Notice how for the code chunk, we use three "```" and for inline code we use a single "`" together with the letter `r` at the beginning.
